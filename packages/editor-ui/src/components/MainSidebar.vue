		...
		<div class="side-menu-wrapper" :class="{expanded: !isCollapsed}">
			...
			<n8n-menu default-active="workflow" @select="handleSelect" :collapse="isCollapsed">
				...
				<n8n-menu-item index="logo" class="logo-item">
					<a href="https://www.liquiditygroup.com/" target="_blank">
						<img :src="basePath + 'n8n-icon-small.png'" class="icon" alt="Liquidity Studio"/>
						<span class="logo-text" slot="title">Options</span>
					</a>
				</n8n-menu-item>
